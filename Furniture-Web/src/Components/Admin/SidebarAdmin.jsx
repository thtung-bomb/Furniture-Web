        ...
        <aside id="cta-button-sidebar" className="z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
            <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50">
                <ul className="flex flex-col space-y-2 font-medium">
                    <li>
                        <Link href="/customer/createRequest" className="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
                    ...
                    <li>
                        <Link href="/customer/function1" className="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
                    ...
                    <li>
                        <Link href="/customer/function2" className="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
                    ...
                    <li>
                        <Link href="/customer/function3" className="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100  group">
                    ...
                    <li>
                        <Link href="/customer/function4" className="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100  group">
                    ...
                    <li>
                        <Link href="/customer/funtion5" className="flex items-center p-2 text-gray-900 rounded-lg  hover:bg-gray-100  group">
                    ...
                    <li>
                        <Link href="/customer/function6" className="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
                            <svg className="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 group-hover:text-gray-900 " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
