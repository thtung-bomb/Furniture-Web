...
function Login() {
    ...
    return (
        <div className='h-[80vh] flex items-center justify-center'>
            <div className='bg-sky-950 p-6 rounded-md shadow-md '>
                <h2 className='text-5xl mb-6'>Login</h2>
                <div className='mb-4'>
                    <label className='block mb-1'>Email:</label>
                    <input type="text" value={username} onChange={(e) => setUsername(e.target.value)} className='w-full px-3 py-2 rounded-md  text-gray-800 focus:outline-none focus:ring focus:ring-blue-300 bgr-white' />
                </div>
                <div className='mb-4'>
                    <label className='block mb-1'>Password</label>
                    <input type="password" value={password} onChange={(e) => setPassword(e.target.value)} className='w-full px-3 py-2 rounded-md  text-gray-800 focus:outline-none focus:ring focus:ring-blue-300 bgr-white' />
                </div>
                <div className="buttonBox">
                    <button className='bg-blue-500  rounded-md hover:bg-blue-600 transition-colors' onClick={handleLogin}>Login</button>
                </div>
